...
大火都来看新功能，Misc -> 管人痴魅力时刻，可以查看包含指定关键词的前100条弹幕，点弹幕内容可以直接跳转到对应场次。

新功能，点击用户页面的消费卡片或者主播页面的流水卡片，可以查看盲盒的盈亏情况。

用户页面的事件筛选器新增盲盒类型。


修复历史大航海列表响应过慢和显示错位的bug
...
- 主播公会查询，粉丝趋势，大航海趋势，历史大航海成员，两段时间之间大航海成员对比，大航海成员活跃度分析，盲盒分析
  - 点击主播页面的**30日内流水**，可以查看各个观众的盲盒胜率
