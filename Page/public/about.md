...
<p style="color:#e3dad5">本站更换了新的域名（vtb.cat），使用之前的域名会自动重定向到新的。</p>


充电收入已计入当月流水，长按或者鼠标悬浮可以分别显示充电收入和直播收入



。~~近期上线录播功能。~~ 暂时搁置

目前全部来自主播自己提供的直播回放，支持
- 跳转到弹幕所在时间
- 实时弹幕回放

如果你想看的主播没有提供直播回放，可以在留言下说下，会使用本站的录播鸡提供录播。
