...
const fetchGuild = async () => {
    if (!localStorage.getItem("guild")) {
        const response = await fetch('https://i0.hdslb.com/bfs/im_new/8e9a54c0fb86a1f22a5da2a457205fcf451537183.png',{
...
const fetchMoney = async () => {
    if (!localStorage.getItem("money")) {
        const response = await fetch('https://i0.hdslb.com/bfs/im_new/de4a78b0e06d48d42eddd6f8a0483b1e451537183.png',{
            referrerPolicy: "no-referrer"
        });
        const arrayBuffer = await response.arrayBuffer()
        var dec = new TextDecoder();
